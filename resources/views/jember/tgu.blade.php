    ...
    <div class="breadcrumb-holder">
        <div class="container-fluid">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item active">tgu</li>
            </ul>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">		
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="alert alert-info" role="alert">
				<center>STO : TANGGUL || Coordinate : XX || Alamat : </center>
			</div>
            <a href="/dashboard/jember" class="btn"><i class="fa fa-arrow-left"></i> Kembali</a>
			<center>
				<form action="" method="post">
					
				<a href="/dashboard/TANGGUL/PLN" type="submit" class="btn btn-secondary" name="PLN" value="PLN">PLN</a>
					<a href="/dashboard/TANGGUL/GENERATOR" type="submit" class="btn btn-secondary" name="GENERATOR" value="GENERATOR">GENERATOR</a>
					<a href="/dashboard/TANGGUL/AC" type="submit" class="btn btn-secondary" name="AC" value="AC">AIR CONDITIONER</a>
					<a href="/dashboard/TANGGUL/RECTIFIER" type="submit" class="btn btn-secondary" name="RECTIFIER" value="RECTIFIER">RECTIFIER</a>
					<a href="/dashboard/TANGGUL/BATTERE" type="submit" class="btn btn-secondary" name="BATTERE" value="BATTERE">BATTERE</a>
				</form>
				<br>
				<form action="" method="post">
