    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">		
		...
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="alert alert-info" role="alert">
				<center>STO : NEGARA || Coordinate : XX || Alamat : </center>
			</div>
            <a href="/dashboard/sgr" class="btn"><i class="fa fa-arrow-left"></i> Kembali</a>
			<center>
				<form action="" method="post">
					
					<a href="/dashboard/NEGARA/PLN" class="btn btn-secondary" name="PLN" value="PLN">PLN</a>
					<a href="/dashboard/NEGARA/GENERATOR" class="btn btn-secondary" name="GENERATOR" value="GENERATOR">GENERATOR</a>
					<a href="/dashboard/NEGARA/AC" class="btn btn-secondary" name="AC" value="AC">AIR CONDITIONER</a>
					<a href="/dashboard/NEGARA/RECTIFIER" class="btn btn-secondary" name="RECTIFIER" value="RECTIFIER">RECTIFIER</a>
					<a href="/dashboard/NEGARA/BATTERE" class="btn btn-secondary" name="BATTERE" value="BATTERE">BATTERE</a>
				</form>
				<br>
				<form action="" method="post">
				...
				<br> <br>
								<img style="height: 401px;" src="/img/singaraja/NEGARA.jpg" alt=""></center>
				<div>
				</div>
				<br>
			</div>
